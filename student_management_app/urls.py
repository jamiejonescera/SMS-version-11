...
urlpatterns = [
    ...
    path('add_yearlevel/', HodViews.add_yearlevel, name="add_yearlevel"),
    path('add_yearlevel_save/', HodViews.add_yearlevel_save, name="add_yearlevel_save"),
    path('manage_yearlevel/', HodViews.manage_yearlevel, name="manage_yearlevel"),
    path('edit_yearlevel/<yearlevel_id>/', HodViews.edit_yearlevel, name="edit_yearlevel"),
    path('edit_yearlevel_save/', HodViews.edit_yearlevel_save, name="edit_yearlevel_save"),
    path('delete_yearlevel/<yearlevel_id>/', HodViews.delete_yearlevel, name="delete_yearlevel"),
    ...
    path('delete_student/<student_id>/', HodViews.update_enrollment_status, name="update_enrollment_status"),
